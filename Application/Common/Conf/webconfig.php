...
//*************************************网站设置****************************************
    ...
    'WEB_ICP_NUMBER'            =>  'XXX',       // 网站ICP备案号
    'ADMIN_EMAIL'               =>  'zlcapture@163.com',          // 站长邮箱

//*************************************优化推广****************************************
    'WEB_NAME'                  =>  '洗剪吹博客',             //网站名：
    'WEB_KEYWORDS'              =>  '专业理码师',         //网站关键字
    'WEB_DESCRIPTION'           =>  '个人博客',      //网站描述
    'AUTHOR'                    =>  'washCutBlow',               //默认作者
    'COPYRIGHT_WORD'            =>  'washcutblow',       //文章保留版权提示
    'IMAGE_TITLE_ALT_WORD'      =>  'washcutblow.com', //图片默认title和alt

//*************************************水印设置****************************************
    'WATER_TYPE'                =>  '1',           //水印类型 0:不使用水印 1:文字水印 2:图片水印 3:文字和图片水印同时使用
    'TEXT_WATER_WORD'           =>  'washcutblow.com',      //文字水印内容
